...
var LoginService = /** @class */ (function () {
    function LoginService(http) {
        this.http = http;
        this.loginUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api.url + "/login";
        this.signUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api.url + "/register";
    }
    ...
    LoginService.prototype.login = function (name, password) {
        return this.http.post(this.loginUrl, { email: name, password: password })
    ...
    LoginService.prototype.signin = function (formData) {
        return this.http.post(this.signUrl, formData);
    };
...
var UniversityService = /** @class */ (function () {
    function UniversityService(http) {
        this.http = http;
        this.apiUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api.url + "/university";
    }
    UniversityService.prototype.getUniversities = function () {
        return this.http.get(this.apiUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (university) {
            return university;
        }));
    };
